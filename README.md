...
| **每天游玩总时长** | 一天内所有游戏**加起来**最多玩 T 分钟。只限款数挡不住每款都玩到天亮，这条管的是总量。与上一条不同，它对今天已经玩过的那款照样生效——总额用完了，换回第一款接着玩正是要拦的事。用完时正在玩的那局也会走预警倒计时后关闭 |
...
GameLimiter.exe --cli daily --minutes 180            # 每天所有游戏加起来最多 180 分钟
